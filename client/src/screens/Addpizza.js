...
export default function Addpizza() {
  ...
  // Use the useSelector hook to select a slice of state from the redux store
  ...
  function formHandler(e){
    ...
    // Create a pizza object from the form data
    const pizza ={
        name ,
        image,
        description,
    ...
    // Dispatch an action to add the pizza to the redux store
  ...
  // Use the useEffect hook to reset the form fields when a new pizza is added
  useEffect(() => {
    if (success) {
      resetForm();
    }

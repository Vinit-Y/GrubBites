...
export default function Registerscreen() {
  // Define state variables to hold form input data and error messages
  ...
  // Access state variables from Redux store
  ...
  // Function to validate password based on regex pattern
  ...
  // Function to validate email based on regex pattern
  ...
  function register() {
    ...
    if (password !== cpassword) {
      ...
      // Create user object and dispatch registerUser action
      const user = {
        name,
        email,
        password,

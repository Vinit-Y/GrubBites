...
const Footer = () => {
  ...
  <div className="container mx-auto px-6 py-12 grid grid-cols-3 gap-6">
    ...
    <div className="column1">
      ...
      <p>
      Welcome to Grub Bites: Food Ordering Website
      </p>
    </div>
    {/* Column 2 */}
    ...
    <div className="column3">
      ...
      <ul>
        ...
        <li>
          <i className="fas fa-envelope w-6 h-2 mb-4"></i> <a href='mailto:info@grubbites.com' class="text-white">info@grubbites.com</a>
        </li>
      </ul>
    </div>
  </div>
...
// This is a React functional component for the footer section of the website.

// The component returns a footer section containing two main
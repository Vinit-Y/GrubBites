...
// Initializing cart items and current user from local storage or null if not found
...
// Creating the store with the finalReducer, initialState and applying middleware using thunk
